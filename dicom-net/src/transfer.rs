//! Default storage abstract syntaxes accepted by the SCP.

use dicom_dictionary_std::uids::*;

/// Supported abstract syntaxes for storage services and verification.
#[allow(deprecated)]
...
/// Storage SOP classes only (excludes verification).
#[allow(deprecated)]
